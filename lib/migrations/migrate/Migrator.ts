...
import migrationListResolver from './migration-list-resolver';
import MigrationGenerator from './MigrationGenerator';
import { getMergedConfig } from './migrator-configuration-merger';
import { isBoolean, isFunction } from '../../util/is';
