...
import { AbstractMigrationsLoader } from '../../common/MigrationsLoader';
import { getFilepathsInFolder } from '../../util/fs';
...
export class FsSeeds extends AbstractMigrationsLoader {
