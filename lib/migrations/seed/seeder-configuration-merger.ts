import { FsSeeds } from './sources/fs-seeds';
import Logger from '../../logger';
import { DEFAULT_LOAD_EXTENSIONS } from '../common/MigrationsLoader';
...
export function getMergedConfig(config, currentConfig, logger = defaultLogger) {
