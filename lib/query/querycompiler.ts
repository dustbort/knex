...
import {
  ...
  wrap as wrap_,
  unwrapRaw as unwrapRaw_,
  rawOrFn as rawOrFn_,
} from '../formatter/wrappingFormatter';

import type Client from '../client';
import type {BindingHolder} from '../formatter'
...
export default class QueryCompiler implements BindingHolder {
  private client: Client;
  bindings?: unknown[];

  constructor(client: Client, builder: QueryBuilder, bindings: BindingHolder['bindings']) {
    this.client = client;
  ...
  toSQL(method: 'select', tz: unknown) {
