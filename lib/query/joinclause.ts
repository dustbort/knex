...
export default class JoinClause {
  private and: unknown;
  private clauses: {
    type: 'onJsonPathEquals' | 'onUsing' | 'onBetween' | 'onIn' | 'onNull' | 'onExists';
    value?: unknown;
    columnFirst?: unknown;
    jsonPathFirst?: unknown;
    columnSecond?: unknown;
    jsonPathSecond?: unknown;
    bool?: JoinClause | 'and' | 'or';
    not?: JoinClause | boolean;
    column?: unknown;
    operator?: unknown;
  }[];
  private _boolFlag?: 'and' | 'or';
  private _notFlag?: boolean;

  constructor(private table, private joinType, private schema?) {
    this.and = this;
    this.clauses = [];
  }
  ...
  _bool(bool: 'and' | 'or'): this;
  _bool(): 'and' | 'or';
  _bool(bool?: 'and' | 'or'): this | 'and' | 'or' {
