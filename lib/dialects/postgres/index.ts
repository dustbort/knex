...
import Transaction from './execution/pg-transaction';
import QueryCompiler from './query/pg-querycompiler';
import QueryBuilder from './query/pg-querybuilder';
import ColumnCompiler from './schema/pg-columncompiler';
import TableCompiler from './schema/pg-tablecompiler';
import ViewCompiler from './schema/pg-viewcompiler';
import ViewBuilder from './schema/pg-viewbuilder';
import SchemaCompiler from './schema/pg-compiler';
import { makeEscape } from '../../util/string';
import { isString } from '../../util/is';

export default class Client_PG extends Client {
  constructor(config) {
    super(config);
    if (config.returning) {
