...
export function s(sequence, post = (v) => v) {
...
export function a(alternative, post = (v) => v) {
  return function ({ index = 0, input }) {
...
export function m(many, post = (v) => v) {
  return function ({ index = 0, input }) {
    let result = {};
    let position = index;
    const ast = [];
...
export function o(optional, post = (v) => v) {
  return function ({ index = 0, input }) {
...
export function l(lookahead, post = (v) => v) {
  return function ({ index = 0, input }) {
...
export function n(negative, post = (v) => v) {
  return function ({ index = 0, input }) {
...
export function t(token, post = (v) => v.text) {
  return function ({ index = 0, input }) {
...
export const e = function ({ index = 0, input }) {
  return { success: true, ast: null, index, input };
};

// Finish parser constant
export const f = function ({ index = 0, input }) {
