...
import MSSQL_Formatter from './mssql-formatter';
import Transaction from './transaction';
import QueryCompiler from './query/mssql-querycompiler';
import SchemaCompiler from './schema/mssql-compiler';
import TableCompiler from './schema/mssql-tablecompiler';
import ViewCompiler from './schema/mssql-viewcompiler';
import ColumnCompiler from './schema/mssql-columncompiler';
import QueryBuilder from '../../query/querybuilder';

import Debug from 'debug';
const debug = Debug('knex:mssql');
...
export default class Client_MSSQL extends Client {
  constructor(config = {}) {
    super(config);
  }
